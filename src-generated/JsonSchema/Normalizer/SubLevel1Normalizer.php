...
class SubLevel1Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Generated\\JsonSchema\\Model\\SubLevel1';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return $data instanceof \Generated\JsonSchema\Model\SubLevel1;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Generated\JsonSchema\Model\SubLevel1();
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($data, new \Generated\JsonSchema\Validator\SubLevel1Constraint());
        ...
        if (\array_key_exists('subLevel-2', $data)) {
            $object->setSubLevel2($this->denormalizer->denormalize($data['subLevel-2'], 'Generated\\JsonSchema\\Model\\SubLevel2', 'json', $context));
        }
        return $object;
    }
