...
class SubLevel2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Generated\\JsonSchema\\Model\\SubLevel2';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return $data instanceof \Generated\JsonSchema\Model\SubLevel2;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Generated\JsonSchema\Model\SubLevel2();
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($data, new \Generated\JsonSchema\Validator\SubLevel2Constraint());
        ...
        if (\array_key_exists('subLevel-3', $data)) {
            $object->setSubLevel3($this->denormalizer->denormalize($data['subLevel-3'], 'Generated\\JsonSchema\\Model\\SubLevel3', 'json', $context));
        }
        return $object;
    }
