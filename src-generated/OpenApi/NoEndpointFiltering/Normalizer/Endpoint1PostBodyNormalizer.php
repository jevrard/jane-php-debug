...
class Endpoint1PostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Generated\\OpenApi\\NoEndpointFiltering\\Model\\Endpoint1PostBody';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Generated\\OpenApi\\NoEndpointFiltering\\Model\\Endpoint1PostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Generated\OpenApi\NoEndpointFiltering\Model\Endpoint1PostBody();
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($data, new \Generated\OpenApi\NoEndpointFiltering\Validator\Endpoint1PostBodyConstraint());
